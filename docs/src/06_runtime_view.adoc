...
image::../images/signup3.png[Sign Up Diagram]
...
image::../images/signin3.png[Sign In Diagram]
...
image::../images/gameplay2.png[Game Flow Diagram]
...
image::../images/statistics3.png[Statistics Flow Diagram]